...
<body> <FORM METHOD=”LINK” ACTION=login>
            ...
            <div class="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-4">
                    <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        ...
                        <li>
                            <a href="/winkelmand/{{$order->id}}" style="margin-top: 10px"
                               class="block py-2 pr-4 pl-3 text-white border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-red-600 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 "><img class="winkelwagen" src="img/winkelwagen-wit.jpg" alt="Winkelwagen"></a>
                        </li>
                        </li>
                    </ul>
                </div>
...
<div class="flex2">
    ...
    @foreach($pizzas as $pizza)
        ...
        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label=".form-select-sm example>
                    <option selected="normaal class="cbsize"></option>
            ...
            <form action="{{route('order_pizzas.store', ['orderid'=>$order->id, 'pizzaid'=>$pizza->id])}}"
                ...
                <input type="submit" value="in_winkel_mandje"
